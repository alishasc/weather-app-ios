...
class DateFormatterUtils {
    ...
    // for current view
    static func formattedDateWithTimezone(from timestamp: TimeInterval, timezone: String) -> String {
        let formatter = DateFormatter()
        formatter.dateFormat = "d MMM yyyy 'at' h a"
    ...
    // for hourly forecast
    static func formatHourlyWithTimezone(from timestamp: TimeInterval, timezone: String) -> String {
        let formatter = DateFormatter()
        formatter.dateFormat = "hh a E"
        formatter.timeZone = TimeZone(identifier: timezone)
    ...
    // for daily forecast
    static func formatDailyWithTimezone(from timestamp: TimeInterval, timezone: String) -> String {
        let formatter = DateFormatter()
    ...
    static func dateTimeWithTimezone(from timestamp: TimeInterval, timezone: String) -> String {
        let formatter = DateFormatter()
